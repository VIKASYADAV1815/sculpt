        ...
        <div className="flex flex-col justify-between gap-8 sm:flex-row">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-[13px] font-light leading-[1.9] text-ink-soft">
              A lime-plaster atelier in Lisbon. Four commissions a year, each
              drawn at full scale before a single hand touches the wall.
            </p>
          </div>
          <div className="flex gap-14">
            <div className="flex flex-col gap-3">
              ...
              <Link
                to="/"
                className="text-[11px] font-light uppercase tracking-[0.28em] text-ink-soft hover:text-ink"
              >
                Home
              </Link>
              <Link
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[11px] font-light uppercase tracking-[0.28em] text-ink-soft/70">
